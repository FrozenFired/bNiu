...
exports.bsMtCategs = async(req, res) => {
	...
	try{
		...
		.sort({"weight": -1})
		return res.render("./user/bser/mtCateg/list", {title: "材料分类管理", MtCategFirs, crUser});
	} catch(error) {
...
exports.bsMtCateg = async(req, res) => {
	...
	try{
		...
		return res.render("./user/bser/mtCateg/detail", {title: "材料分类详情", MtCateg, crUser});
	} catch(error) {
...
exports.bsMtCategUp = async(req, res) => {
	...
	try{
		...
		return res.render("./user/bser/mtCateg/update", {title: "材料分类详情", MtCateg, crUser});
	} catch(error) {
		return res.redirect("/error?info=bsMtCategAdd,Error&error="+error);
	}
}
...
exports.bsMtCategAdd = async(req, res) => {
	...
	try{
		...
		return res.render("./user/bser/mtCateg/add", {title: "添加新材料分类", MtCategFar, crUser});
	} catch(error) {
		return res.redirect("/error?info=bsMtCategAdd,Error&error="+error);
	}
}
