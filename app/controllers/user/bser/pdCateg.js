...
exports.bsPdCategs = async(req, res) => {
	...
	try{
		...
		.sort({"weight": -1})
		return res.render("./user/bser/pdCateg/list", {title: "产品分类管理", PdCategFirs, crUser});
	} catch(error) {
...
exports.bsPdCateg = async(req, res) => {
	...
	try{
		...
		return res.render("./user/bser/pdCateg/detail", {title: "产品分类详情", PdCateg, crUser});
	} catch(error) {
...
exports.bsPdCategUp = async(req, res) => {
	...
	try{
		...
		return res.render("./user/bser/pdCateg/update", {title: "产品分类详情", PdCateg, crUser});
	} catch(error) {
		return res.redirect("/error?info=bsPdCategAdd,Error&error="+error);
	}
}
...
exports.bsPdCategAdd = async(req, res) => {
	...
	try{
		...
		return res.render("./user/bser/pdCateg/add", {title: "添加新产品分类", PdCategFar, crUser});
	} catch(error) {
		return res.redirect("/error?info=bsPdCategAdd,Error&error="+error);
	}
}
